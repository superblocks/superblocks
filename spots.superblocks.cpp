//
// Predict next block reward for: Spots (SPT)
// reward -  normal: 49 - superblock: 10045 - repo: https://github.com/spots-project/spots
//
// Version 0.4
//
// superblock test:  ./spt ??? debug
//
#include <stdio.h>
#include <string.h>
...
int main( int argc, char **argv ) {
        ...
        if( rand > rnd_lucky_low && rand < rnd_lucky_high )
